...
func (r *Radarr) UpdateIndexers(indexer *BulkIndexer) (*IndexerOutput, error) {
	return r.UpdateIndexersContext(context.Background(), indexer)
}

// UpdateIndexersContext bulk updates indexers.
func (r *Radarr) UpdateIndexersContext(ctx context.Context, indexer *BulkIndexer) (*IndexerOutput, error) {
	var (
		output IndexerOutput
		body   bytes.Buffer
	)
