...
// CustomFilter is the /api/v3/customfilter resource (UI saved filters, not custom formats).
type CustomFilter = starrshared.CustomFilter

// GetCustomFilters returns all custom filters.
func (r *Radarr) GetCustomFilters() ([]*CustomFilter, error) {
	return r.GetCustomFiltersContext(context.Background())
}

// GetCustomFiltersContext returns all custom filters.
func (r *Radarr) GetCustomFiltersContext(ctx context.Context) ([]*CustomFilter, error) {
...
func (r *Radarr) GetCustomFilter(id int) (*CustomFilter, error) {
	return r.GetCustomFilterContext(context.Background(), id)
}

// GetCustomFilterContext returns a single custom filter.
func (r *Radarr) GetCustomFilterContext(ctx context.Context, id int) (*CustomFilter, error) {
	var output CustomFilter
...
func (r *Radarr) AddCustomFilter(in *CustomFilter) (*CustomFilter, error) {
	return r.AddCustomFilterContext(context.Background(), in)
}

// AddCustomFilterContext creates a custom filter.
func (r *Radarr) AddCustomFilterContext(ctx context.Context, in *CustomFilter) (*CustomFilter, error) {
	var output CustomFilter
...
func (r *Radarr) UpdateCustomFilter(in *CustomFilter) (*CustomFilter, error) {
	return r.UpdateCustomFilterContext(context.Background(), in)
}

// UpdateCustomFilterContext updates a custom filter.
func (r *Radarr) UpdateCustomFilterContext(ctx context.Context, input *CustomFilter) (*CustomFilter, error) {
	var output CustomFilter
...
func (r *Radarr) DeleteCustomFilter(id int) error {
	return r.DeleteCustomFilterContext(context.Background(), id)
}

// DeleteCustomFilterContext deletes a custom filter.
func (r *Radarr) DeleteCustomFilterContext(ctx context.Context, id int) error {
	req := starr.Request{URI: path.Join(bpCustomFilter, starr.Str(id))}
