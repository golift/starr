...
// GetRename checks if the specified book (database ID) from the author (database ID) needs to be renamed to
...
// GetRenameContext checks if the specified book (database ID) from the author (database ID) needs to be renamed to
// follow the naming format. If bookId is set to -1, it will check all books at once.
