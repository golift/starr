...
func (r *Readarr) GetTagDetails() ([]*TagDetails, error) {
	return r.GetTagDetailsContext(context.Background())
}

// GetTagDetailsContext returns tag usage details for all tags.
func (r *Readarr) GetTagDetailsContext(ctx context.Context) ([]*TagDetails, error) {
...
func (r *Readarr) GetTagDetail(tagID int) (*TagDetails, error) {
	return r.GetTagDetailContext(context.Background(), tagID)
}

// GetTagDetailContext returns tag usage details for a single tag.
func (r *Readarr) GetTagDetailContext(ctx context.Context, tagID int) (*TagDetails, error) {
	var output TagDetails
