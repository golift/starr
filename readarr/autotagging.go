...
func (r *Readarr) GetAutoTaggings() ([]*AutoTagging, error) {
	return r.GetAutoTaggingsContext(context.Background())
}

// GetAutoTaggingsContext returns all auto tagging configurations.
func (r *Readarr) GetAutoTaggingsContext(ctx context.Context) ([]*AutoTagging, error) {
...
func (r *Readarr) GetAutoTagging(id int) (*AutoTagging, error) {
	return r.GetAutoTaggingContext(context.Background(), id)
}

// GetAutoTaggingContext returns a single auto tagging configuration.
func (r *Readarr) GetAutoTaggingContext(ctx context.Context, id int) (*AutoTagging, error) {
	var output AutoTagging
...
func (r *Readarr) GetAutoTaggingSchema() ([]*AutoTaggingSpecification, error) {
...
func (r *Readarr) GetAutoTaggingSchemaContext(ctx context.Context) ([]*AutoTaggingSpecification, error) {
...
func (r *Readarr) AddAutoTagging(in *AutoTagging) (*AutoTagging, error) {
	return r.AddAutoTaggingContext(context.Background(), in)
}

// AddAutoTaggingContext creates an auto tagging configuration.
func (r *Readarr) AddAutoTaggingContext(ctx context.Context, in *AutoTagging) (*AutoTagging, error) {
	var output AutoTagging
...
func (r *Readarr) UpdateAutoTagging(in *AutoTagging) (*AutoTagging, error) {
	return r.UpdateAutoTaggingContext(context.Background(), in)
}

// UpdateAutoTaggingContext updates an auto tagging configuration.
func (r *Readarr) UpdateAutoTaggingContext(ctx context.Context, input *AutoTagging) (*AutoTagging, error) {
	var output AutoTagging
...
func (r *Readarr) DeleteAutoTagging(id int) error {
	return r.DeleteAutoTaggingContext(context.Background(), id)
}

// DeleteAutoTaggingContext deletes an auto tagging configuration.
func (r *Readarr) DeleteAutoTaggingContext(ctx context.Context, id int) error {
	req := starr.Request{URI: path.Join(bpAutoTagging, starr.Str(id))}
